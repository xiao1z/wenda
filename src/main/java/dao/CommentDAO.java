...
public interface CommentDAO {
	...
	@Delete({"delete from ",TABLE_NAME,"where entity_id=#{entityId} and entity_type=#{entityType}"})
	public int deleteCommnet(@Param("entityId") int entityId,@Param("entityType") int entityType);
}
