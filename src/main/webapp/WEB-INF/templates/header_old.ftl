...
<head>
    ...
    <script type="text/javascript" src="/wenda/static/scripts/za-0.1.1.min.js"></script>
    <script src="/wenda/static/scripts/ga.js"></script>
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <meta name="renderer" content="webkit">
    <title>首页</title>
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
    <link rel="stylesheet" href="/wenda/static/styles/index.css">
    <style>
...
<div role="navigation" class="zu-top">
    <div class="zg-wrap modal-shifting clearfix" id="zh-top-inner">
        ...
        <div class="top-nav-profile">
            <#if user??>
			<a href="/wenda/user/${user.id}" class="zu-top-nav-userinfo " id=":0" role="button" aria-haspopup="true" aria-activedescendant="">
                <span class="name">${user.username}</span>
                <img class="Avatar" src="${user.headUrl}" alt="${user.username}">
            ...
            <ul class="top-nav-dropdown" id="top-nav-profile-dropdown" aria-labelledby=":0">
                <li>
                    <a href="/wenda/user/${user.id}" tabindex="-1" id=":1">
                ...
                <li>
                    <a href="/wenda/logout" tabindex="-1" id=":4">
        ...
        <div id="zg-top-nav" class="zu-top-nav">
            <ul class="zu-top-nav-ul zg-clear">
                ...
                <li class="zu-top-nav-li " id="zh-top-nav-explore">
                    <a class="zu-top-nav-link" href="/pullfeeds">兴趣</a>
                </li>
                <#if user??>
